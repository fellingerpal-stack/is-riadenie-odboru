...
export default function DepartmentPortal({go}:{go:Go}){
  return <div className="department-portal">
    ...
    <section className="shared-technology-entry panel"><div><span className="shared-technology-icon"><Icon name="shield" size={27}/></span><div><span className="eyebrow">SPOLOČNÉ RIADIACE CENTRUM</span><h2>Service 360 · Control Tower · lifecycle · forecast</h2><p>Jedna manažérska obrazovka nad službami, RACI, technológiami, incidentmi, problémami, zmenami, nákladmi, dodávateľskou koncentráciou a rozpočtovým forecastom úloh 10/22/25.</p></div></div><button className="button button-primary" onClick={()=>go('intelligence')}>Otvoriť riadiace centrum <Icon name="arrow" size={17}/></button></section>
