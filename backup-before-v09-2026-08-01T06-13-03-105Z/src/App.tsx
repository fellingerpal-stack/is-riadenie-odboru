...
type ViewKey='dashboard'|'people'|'raci'|'services'|'substitutions'|'capacity'|'work'|'helpdesk'|'changes'|'problems'|'iam'|'risks'|'decisions'|'roadmap'|'users'
